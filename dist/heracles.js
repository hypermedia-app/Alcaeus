...
$__System.registerDynamic("3", ["4", "7", "8", "5", "9", "a", "b", "6"], true, function($__require, exports, module) {
  ...
  var FetchUtil = (function() {
    ...
    FetchUtil.fetchResource = function(uri) {
      return window.fetch(uri, {headers: {accept: FetchUtil._requestAcceptHeaders}}).then(rejectNotFoundStatus).then(function(res) {
...
$__System.registerDynamic("10", ["7", "6", "d", "c", "5", "f"], true, function($__require, exports, module) {
  ...
  var IncomingLink = (function() {
    function IncomingLink(id, predicate, resources) {
      ...
      Object.defineProperty(this, 'subject', {get: function() {
          return resources[id];
        }});
    }
...
$__System.registerDynamic("e", ["11"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this || self,
