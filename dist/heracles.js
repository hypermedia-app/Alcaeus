...
(["1"], ["3","4","5","6","7","8","20","34","39","3a","3b","3c"], function($__System) {
...
$__System.register("2", ["3", "4", "5", "a", "b", "6", "7", "8", "9"], function(exports_1, context_1) {
    ...
    var li, _, jsonld_1, Constants, $rdf, rdf_formats_common_1, JsonLdSerializer, vocabs_rdf_1;
    ...
    function runInference(graph) {
        _.map(FetchUtil._propertyRangeMappings, function (mapping) {
            ...
            _.forEach(matches.toArray(), function (triple) {
                graph.add(new $rdf.Triple(triple.object, new $rdf.NamedNode(vocabs_rdf_1.type), new $rdf.NamedNode(mapping[1])));
            });
        });
        return graph;
    }
    ...
    return {
        setters:[
            ...
            function (vocabs_rdf_1_1) {
                vocabs_rdf_1 = vocabs_rdf_1_1;
            }],
        execute: function() {
            ...
            FetchUtil = (function () {
                ...
                FetchUtil._propertyRangeMappings = [
                    ...
                    [Constants.Core.Vocab.property, vocabs_rdf_1.ns + 'Property'],
...
$__System.registerDynamic("16", ["f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("18", ["f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("1a", ["f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("f", ["1e"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("1f", ["f", "20"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("22", ["10", "12", "14", "9", "17", "19", "1b", "1d", "21"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("2a", ["24", "25", "26", "27", "28", "29", "20"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.register("33", ["4", "23", "a", "35", "34", "b"], function(exports_1, context_1) {
    'use strict';
    var __moduleName = context_1 && context_1.id;
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
...
$__System.register("37", ["4", "23", "35", "33", "a", "36"], function(exports_1, context_1) {
    'use strict';
    var __moduleName = context_1 && context_1.id;
